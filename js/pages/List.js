        ...
        <main v-else class="page-list">
            ...
            <div class="meta-container">
                <div class="meta">
                    ...
                    <p>The recording must have a previous attempt and entire death animation shown before the completion</p>
                    <p>The recording must also show the player hit the endwall</p>
                    <p>Do not use secret routes or bug routes</p>
                    <p>Do not use easy modes</p>
